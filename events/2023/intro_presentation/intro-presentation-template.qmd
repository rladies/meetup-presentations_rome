...
subtitle: "event name<br><br>date"
format: 
  rladies-revealjs:
...
[https://rladies.org/code-of-conduct/](https://rladies.org/code-of-conduct/){.uri style="color: #0071bc"}


# Materials for tonight {.smaller}

This section depends on the event requirenments
