...
subtitle: "Interactive R, Python, and Shiny in the Browser with Quarto and Shinylive,<br>Speaker: Isabella Velásquez<br>21 February, 2025"
format: 
  rladies-revealjs:
...
In this talk, **Isabella Velásquez** will introduce **Quarto Live** and **Shinylive**, tools that enable interactive R, Python, and Shiny applications to run directly in the browser—no server required!  

```
- 📊 You’ll learn how to create interactive documents 
- 💡 Dashboards, and educational content  
- 🛠 Expect hands-on demonstrations
- 🤔 Gain insights on how enhance reproducibility, accessibility, and engagement
```
...
- [Kylie Ainslie, PhD](https://www.linkedin.com/in/kylieainslie/) Infectious Disease Modelling Senior Researcher 
...
We are thrilled to have with us [Isabella Velásquez](https://www.linkedin.com/in/ivelasq/), Senior Product Marketing Manager at Posit PBC, where she merges content strategy, data analysis, and programming to showcase the incredible work happening at Posit. She’s a passionate advocate for open-source, always exploring new tools to empower data scientists. Today, she’ll walk us through Quarto Live and Shinylive, showing how we can create fully interactive, browser-based R and Python applications—without a server! Let’s give a warm welcome to **Isabella**!🌟
